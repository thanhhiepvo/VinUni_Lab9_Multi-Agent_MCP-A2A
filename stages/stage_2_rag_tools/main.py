...
QUESTION = (
    "Công ty vi phạm hợp đồng lao động bằng cách sa thải nhân viên "
    "không có lý do chính đáng thì phải chịu trách nhiệm pháp lý gì? "
    "Thời hiệu khởi kiện cho vụ án hợp đồng là bao lâu?"
)
